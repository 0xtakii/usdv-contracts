...
interface IUsfExternalRequestsManager is IDefaultErrors {
    ...
    event UsfRedemptionExtensionSet(address usfRedemptionExtensionAddress);
    ...
    function setUsfRedemptionExtension(IUsfRedemptionExtension _usfRedemptionExtension) external;
