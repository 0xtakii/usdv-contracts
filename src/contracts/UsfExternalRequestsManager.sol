...
contract UsfExternalRequestsManager is IUsfExternalRequestsManager, AccessControlDefaultAdminRules, Pausable {
    ...
    IUsfRedemptionExtension public usfRedemptionExtension;
    ...
    constructor(
        ...
        address _usfRedemptionExtension,
        ...
        usfRedemptionExtension = IUsfRedemptionExtension(_assertNonZero(_usfRedemptionExtension));
